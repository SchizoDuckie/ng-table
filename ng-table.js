 ...
 */
     ...
     */
    app.factory('NgTableParams', ['$q', '$log',
        function($q, $log) {
     ...
     */
    var ngTableController = ['$scope', 'NgTableParams', '$timeout',
        function($scope, NgTableParams, $timeout) {
            ...
            $scope.$watch('params.$params', function(newParams, oldParams) {
                ...
                if (oldParams && oldParams.filter && !angular.equals(newParams.filter, oldParams.filter)) {
